...
def check_outfile_name(outfile: str, file_exists_ok: bool = False) -> Tuple[bool, str]:
    """
...
def find_task_from_filename(filepath: Optional[str]) -> Optional[str]:
    """
...
def map_chaos_pipe_result_to_float(result: Any) -> Optional[float]:
    """
