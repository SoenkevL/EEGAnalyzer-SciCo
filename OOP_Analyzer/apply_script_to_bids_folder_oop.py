...
def check_file_exists_and_create_path(log_file, append_datetime=False):
    ...
    -new logfile path
    '''
    # TODO: add functionality to handle non type in logfile
                    ...
                    for file in files:
                        ...
                        if file.endswith("raw.fif"):
                            ...
                            if outfile_ending.endswith("metrics.csv"):
                                ...
                                eegprocessor = EEG_processor(full_path)
                                print(eegprocessor.compute_metrics(metric_set_name, annotations, outpath, lfreq, hfreq,
